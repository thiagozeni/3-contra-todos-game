...
export class ProtectedChar extends Phaser.GameObjects.Image {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    // 0.877 * 1.06 * 1.04 * 1.03: wand +6% (r3) + 4% (r4) + 3% (r5). Mantido em sincronia
    // com wandScale() em systems/movement.ts (a elipse de colisão usa o MESMO fator).
    this.baseScaleY = (dispH / frameH) * 0.877 * 1.06 * 1.04 * 1.03
